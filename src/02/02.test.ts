...
beforeEach(() => {
    city = {
        ...
        governmentBuildings: [
            {
                type: "HOSPITAL", budget: 2000000, staffCount: 200, address: {street: {title: "Central Str"}}
            },{
                type: "FIRE-STATION", budget: 5000000, staffCount: 1000, address: {street: {title: "South Str"}}
            },
        ],
...
test("test city should contains hospital and fire station", () => {
    ...
    expect(city.governmentBuildings[1].budget).toBe(5000000);
